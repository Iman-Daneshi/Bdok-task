...
from server.models.basket import (
    ErrorResponseModel,
    ResponseModel,
    BasketSchema,
    UpdateBasketModel,
...
@router.get("/", response_description="baskets retrieved")
...
@router.get("/{id}", response_description="basket data retrieved")
...
@router.put("/{id}")
async def update_basket_data(id: str, req: UpdateBasketModel = Body(...)):
